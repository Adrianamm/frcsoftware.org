...
Before we learn about variables, we’ll learn about print statements. When programming, it can be useful to print information to a terminal. This can be helpful for making programs that display information to the user or printing out what the motor speed is. In Java, we can print information using a print statement. 
