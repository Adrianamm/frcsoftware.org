...
<Aside type="tip">
    ...
    are designed to build skills through a carefully crafted progression.
    Therefore, you will struggle if stages are skipped.
</Aside>
...
>
    <p>
        ...
        <Aside type="caution">Stage 1 uses Command v3 which will only run on a Systemcore.
...
>
    <p>
        <Aside type="wip">
            ...
            indexer mechanisms, learn about feedfoward control, gain more
