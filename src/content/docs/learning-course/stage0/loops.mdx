...
<Aside type="note">
    There is another type of loop, the do-while loop.
    We will not be covering it because it isn't commonly used in FRC. 
    However, if you want to learn more about do while loops, 
    you can learn more on w3school's page on [do while
