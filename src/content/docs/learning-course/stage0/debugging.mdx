...
Even though there are no errors so it appears that everything should run fine.
...
The way to fix this error would be to swap the 10 and 0.
...
- For some, changing VS Code to be in a more accessible font (e.i Comic Sans) can be helpful in reading code to find or avoid errors.
