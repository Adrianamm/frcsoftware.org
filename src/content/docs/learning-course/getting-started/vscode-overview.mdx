...
In Stage 0, you will write code based on the instructions provided in each exercise.
...
<ContentFigure src="/learning-course/getting-started/vscode-overview/RunCode.webm" />
