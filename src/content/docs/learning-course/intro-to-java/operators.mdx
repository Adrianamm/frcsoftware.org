        ...
        <p>
            <ul>
                <li>
                    ...
                    `answerTwo` is false, therefore the operator will return
                    false.
                </li>
                <li>
                    true. || returns true if one of the statements are true
                    `answerOne` is true, therefore the the operator will return
                    true.
                </li>
                <li>
                    false. ! reverses the outcome `answerOne` is true, adding !
                    will reverse it and return false.
                </li>
            </ul>
        </p>
    </div>
