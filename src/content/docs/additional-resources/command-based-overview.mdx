...
<Aside type="note">
    For Commmands V3, please see link
</Aside>
...
Command-Based models this relationship Subsystems.

##### Subsystems

A Subsystems is a robot component whose state can be updated through commands.
`Command`s declare
the subsystems they require - thus, subsystems are also called "requirements".

An intake is a subsystem because your code controls its speed.
On the other hand,
