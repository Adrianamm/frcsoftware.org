...
## git
The next tool is Git. Git is a version control system that is used in FRC because it allows teams to keep track of changes made to the robot’s code throughout 
the build and competition season. It can also help teams manage their robot code through the various features that GitHub has such as Pull Requests, Issues and Project boards
